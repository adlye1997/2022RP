...
/* 底盘电机can驱动 */
drv_can_t chassis_motor_can[4] = 
{
	[LF] = 
	{
		.hcan = &hcan1,
		.rx_id = chassis_motor_LF_id,
	},
	[RF] = 
	{
		.hcan = &hcan1,
		.rx_id = chassis_motor_RF_id,
	},
	[LB] = 
	{
		.hcan = &hcan1,
		.rx_id = chassis_motor_LB_id,
	},
	[RB] = 
	{
		.hcan = &hcan1,
		.rx_id = chassis_motor_RB_id,
	},
};
...
{
	.hcan = &hcan1,
	.rx_id = gimbal_motor_yaw_id,
};

/* 云台pitch电机can驱动 */
drv_can_t gimbal_motor_pitch_can = 
{
	.hcan = &hcan2,
	.rx_id = gimbal_motor_pitch_id,
};

/* 拨盘电机can驱动 */
drv_can_t dial_motor_can = 
{
	.hcan = &hcan1,
	.rx_id = dial_motor_id,
};
...
/* 左摩擦轮电机can驱动 */
drv_can_t friction_left_motor_can = 
{
	.hcan = &hcan2,
...
/* 右摩擦轮电机can驱动 */
drv_can_t friction_right_motor_can = 
{
	.hcan = &hcan2,
